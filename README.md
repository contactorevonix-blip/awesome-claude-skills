...
- [Greenfield Project Setup](./greenfield-project-setup/) - Full senior engineer workflow for new projects from scratch — discovery, stack selection, architecture decisions, scaffolding, tooling configuration, and CI/CD setup.
